...
def get_conditions():
	api_conditions_url = "https://min-api.cryptocompare.com/data/price?fsym=ADA&tsyms=USD"
	try:
...
def lambda_handler(event, context):
    ...
    payload = json.dumps({'state': { 'desired': { 'ada-vals-by-minute': arr } }})
