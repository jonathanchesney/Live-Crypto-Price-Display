...
def get_conditions():
	api_conditions_url = "https://min-api.cryptocompare.com/data/price?fsym=ETH&tsyms=USD"
	try:
...
def lambda_handler(event, context):
    ...
    payload = json.dumps({'state': { 'desired': { 'eth-vals-by-minute': arr } }})
